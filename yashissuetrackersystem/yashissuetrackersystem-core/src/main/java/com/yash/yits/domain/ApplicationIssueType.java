...
/**
 * The persistent class for the application_issue_type database table.
 * 
 */
@Entity
@Table(name="application_issue_type")
@NamedQuery(name="ApplicationIssueType.findAll", query="SELECT a FROM ApplicationIssueType a")
public class ApplicationIssueType implements Serializable {
	...
	@OneToMany(mappedBy="applicationIssueType", fetch=FetchType.EAGER)
	private List<Issue> issues;

	public ApplicationIssueType() {
	}
	...
	public Issue addIssue(Issue issue) {
		getIssues().add(issue);
		issue.setApplicationIssueType(this);
	...
	public Issue removeIssue(Issue issue) {
		...
		issue.setApplicationIssueType(null);
