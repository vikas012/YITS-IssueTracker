				...
				[
						...
						function($http, $q) {
							return {
								...
								fetchIssueDetailsConv : function(id) {
									...
									return $http
											...
											.then(
													...
													function(errResponse) {
														console
																.error('Error while fetchIssueDetails member');
														return $q
																.reject(errResponse);
													});
								...
								/*
								 * EditIssue:function(){ return
								 * $http.get('./defaultIssuesList') .then(
